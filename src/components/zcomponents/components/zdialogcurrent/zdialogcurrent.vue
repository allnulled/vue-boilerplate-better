...
<div class="Component zdialogport">
  <div class="dialog_container" v-if="dialogs.length">
    <div class="dialog_box">
      <dialog class="dialog">
        <div class="window">
          <div class="title-bar">
            <div class="title-bar-text">{{ dialogs[0].title }}</div>
          </div>
          <div class="window-body">
            <form>
              <zdialogcurrent></zdialogcurrent>
            </form>
          </div>
          <div class="status-bar">
            <div class="status-bar-field">{{ dialogs[0].footer }}</div>
          </div>
        </div>
      </dialog>
    </div>
  ...
  methods: {
    ...
    async close_first() {
      try {
        ...
        this.window.$vue.component("zdialogcurrent", {
          template: html_vue,
    ...
    async error(error) {
      try {
        ...
        html = "<zlayout style='color: red;text-shadow: 0 0 2px red;'>" + html + "</xlayout>";
